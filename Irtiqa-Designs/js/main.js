...
$(".home-slider").owlCarousel({
  ...
  responsiveRefreshRate: 200
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // For mobile devices, we need to ensure the video plays
            video.play().catch(error => {
                // Autoplay was prevented, show a play button or handle accordingly
    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      if (!window.matchMedia("(prefers-reduced-motion: reduce)").matches) {
        scrollers.forEach((scroller) => {
          ...
          const inner = scroller.querySelector(".clients-scroller__inner");
  ...
  // Adjust animation speed based on window size
  function adjustAnimation() {
    const speed = window.innerWidth < 768 ? 40 : 30;
